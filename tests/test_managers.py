...
class TestMarketingBlockManagers(object):
    ...
    def test_get_block_contents_by_position_fail_silently(
        self, active_header_block
    ):
        ...
        # WHEN
        dict_blocks = MarketingBlock.objects.get_block_contents_by_position(backend="stromboli")
